...
let ImagenesRepository = class ImagenesRepository extends typeorm_1.Repository {
};
ImagenesRepository = __decorate([
    (0, typeorm_1.EntityRepository)(imagenes_entity_1.ImagenesEntity)
], ImagenesRepository);
